  ...
  fields: (rows) =>
    fieldsFrom(
      [
        ...
        { key: "contract_closed", label: "Contract closed (final account)", type: "boolean", inDefault: false, help: "The final account for this contract is signed, not required or a direct payment." },
  ...
  build: (programmeId) => {
    ...
    for (const c of claims) {
      ...
      out.push({
        ...
        contract_closed: c.contract_closed === true,
        status,
