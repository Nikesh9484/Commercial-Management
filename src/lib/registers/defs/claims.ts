...
const STATUS_FIELDS: FieldDef[] = [
  ...
  { key: "last_action_date", label: "Date of last action", type: "date", section: ACTIONS, hideInTable: true, help: "Drives \"days since last action\" on the EOT / claims tracker. Left empty, the tracker falls back to when the row was last edited." },
  { key: "target_date", label: "Target date for the next step", type: "date", section: ACTIONS, hideInTable: true, help: "Drives \"days to / overdue target\" on the EOT / claims tracker." },
