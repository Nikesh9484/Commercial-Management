  ...
  const groups: { heading: string; items: { section: string; title: string; note: string }[] }[] = [
    {
      ...
      items: [
        ...
        item("changes_report", "Change Management Status Report", "Executive change report: stage-by-stage value, ageing of open changes, cost report exposure"),
        item("ew_report", "Early Warnings & Risks Status Report", "Executive report on open early warnings and the risk / opportunity register, with exposure and ageing"),
        item("ps_report", "Provisional Sums Status Report", "Executive report on budget vs instructed value, savings and extras"),
        item("bonds_report", "Bonds & Insurance Status Report", "Executive report on cover held vs required, expiry timeline and compliance checks"),
        item("transfers_report", "Budget Transfers Status Report", "Executive report on budget moved between packages, approved vs pending, and the cost report reconciliation"),
